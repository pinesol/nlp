...
Running this program without --decode will use the training data and tokenize
it in a very basic way, and then start training a model saving checkpoints to
--train_dir.

Running with --decode starts an interactive loop so you can see how
the current checkpoint translates Japanese into English.
"""
...
def train():
  ...
  with tf.Session() as sess:
    ...
    dev_set = read_data(ja_dev, en_dev)
    train_set = read_data(ja_train, en_train, FLAGS.max_train_data_size)
    # Number of training sentence-pairs in each bucket
    ...
    # NOTE: I think this is the cumulative probability mass function.
